	        ...
	        <form class="needs-validation" novalidate>
	          <div class="row g-3">
	            ...
	            <div class="col-sm-6">
	              ...
	              <input type="date" class="form-control" name="eventDate" placeholder="날짜를 입력하세요" value="${record.eventDate}">
	            </div>
	            <div class="col-12">
	            	<div class="row">
		              <label class="form-label">Content</label>
		              <textarea class="from-control" name="content" rows="5" placeholder="내용을 입력하세요">${record.content}</textarea>
	            	</div>
	            </div>
	          </div>
	          ...
	          <button class="w-100 btn btn-primary btn-lg" type="submit">Update the Event</button>
	      ...
	      <div class="col-md-5 col-lg-4 order-md-last">
	        ...
	        <ul class="list-group mb-3">
	          ...
	          <li class="list-group-item d-flex justify-content-between lh-sm">
	            ...
	            <span class="text-muted" name="latitude2" value="${record.latitude}">Latitude</span>
	          </li>
	          ...
	          <li class="list-group-item d-flex justify-content-between lh-sm">
	            ...
	            <span class="text-muted" name="longitude2" value="${record.longitude}">Longitude</span>
	          </li>
	          ...
	          <li class="list-group-item d-flex justify-content-between lh-sm">
	            ...
	            <span class="text-muted" name="eventAddress2" value="${record.eventAddress}">Address</span>
	          </li>
	        </ul>
	        <div class="row">
				<div class="col-sm-8">
