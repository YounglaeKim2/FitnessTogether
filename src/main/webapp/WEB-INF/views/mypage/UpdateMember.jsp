	...
	<a class="navbar-brand js-scroll-trigger" href="#page-top">
		...
		<div id="main">
			<div class="content"
				...
				<form action="<c:url value="/fnt/UpdateMemberPro.do"/>"
					method="post">
					<table class="w-pct60">
						<tr>
							<th class="w-px161">아이디</th>
							<td>
								<input type="text"  id="id" name="id" class="chk" onkeyup="idKeyup()" onfocus="showTextid()" placeholder="${sessionScope.id }" /> 
						...
						<tr>
							<th>이메일</th>
							<td><input type="text" id="email" name="email" onkeyup="emailKeyup()"  placeholder="${sessionScope.email}" /> 
						...
						<tr>
							<th>생년월일</th>
							<td>
							<input type="text" name="birth" id="birth_year" pattern="[0-9]*"  size="4" maxlength="4" placeholder="" style="width:100px;">						
							<input type="text" name="birth" id="birth_month" pattern="[0-9]*" size="2" maxlength="2" placeholder="" style="width:100px;">		
							<input type="text" name="birth" id="birth_day" pattern="[0-9]*" size="2" maxlength="2" placeholder="" style="width:100px;">
							</td>
						</tr>
						<tr>
							<th>전화번호</th>
							<td><input type="text" maxlength="11" id="phone" name="phone" placeholder="${sessionScope.phone}" style="width: 200px;" /></td>
						</tr>
					</table>
					<hr class="hr-4" style="height: 3px;">
